...
const val GAMORRA_DESCRICAO =
    "Gamorra foi uma personagem fictícia que apareceu nas histórias em quadrinhos publicadas pela Marvel Comics. Criada por Jim Starlin, a personagem apareceu pela primeira vez em \\\"Strange Tales\\\" #180. Gamora foi a filha adotiva de Thanos, e a última de sua espécie.\"\n"
...
const val MULHER_INVISIVEL_NOME = "Mulher Invisível"
